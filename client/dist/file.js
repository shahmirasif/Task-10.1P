...
#requests {
	...
	.new-request-description {
		...
		.new-request-description-text {
			font-size: 1.3rem;
		}

		.new-request-description-content {
			margin-top: 15px;
			.description-row {
				display: flex;
				margin-bottom: 10px;
	...
	.new-request-settings {
		...
		.new-request-settings-text {
			font-size: 1.3rem;
		}

		.new-request-settings-content {
			margin-top: 10px;
	...
	.new-request-requirements {
		margin-top: 20px;
		.new-request-requirements-text {
			font-size: 1.3rem;
		}
		.new-request-requirements-content {
			margin-top: 10px;

			.new-request-requirements-row {
				.answer {
					flex-direction: row;
				}
			}
	...
	return (
		<div className="new-request-settings">
			...
			<div className="new-request-settings-content">
				<div className="new-request-title">Task Name : {title || 'Title'}</div>
				<div className="new-request-desc">Description : {desc || 'Description'}</div>
